...
>(({ className, variant = "outline", size = "icon", ...props }, _ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        orientation === "horizontal"
          ? `top-1/2 -left-10 md:-left-14 -translate-y-1/2 active:-translate-y-1 w-8 h-9
            md:w-9 md:h-10 `
      ...
      className={cn(
        orientation === "horizontal"
          ? `top-1/2 -right-10 md:-right-14 -translate-y-1/2 active:-translate-y-1
            aspect-square shrink-0 w-8 h-9 md:w-9 md:h-10 `
